...
// #include "iMolkat_core.h"
// iMolkat_core::iMolkat_core(){
...
// void iMolkat_core::responseHtml(lua_State *lua)
// {
...
// String iMolkat_core::httpGet(String url) {
//   String payload ;
...
// int iMolkat_core::ConvertInttoString(lua_State *lua){
...
// bool iMolkat_core::db_select(lua_State *lua){
...
// bool iMolkat_core::db_exec(lua_State *lua){
//   size_t *ldn;
//   size_t *lsql;
//   const char* dbName =  luaL_checklstring(lua, 1, ldn);
//   const char* sql = luaL_checklstring(lua, 2, lsql);
...
// void iMolkat_core::handleRoot() {
//   server.send(200, "text/html", getHtml());
// }

// void iMolkat_core::handleNotFound() {
...
// void iMolkat_core::manageApis(String lua_code){
...
// // String iMolkat_core::file_open(char *path) {
